...
if __name__ == "__main__":
    ...
    reevaluated_optimal_policy_variable_extractor(
        ...
        path_to_data="data/reevaluation/only_welfare_temp",  # "data/reevaluation/comparison_experiments",
        path_to_output="data/reevaluation/only_welfare_temp/extracted_variable",  # "data/reevaluation/comparison_experiments",
        variable_name="global_temperature",  # "net_economic_output",  # "economic_damage",  # "emissions", #abatement_cost, # "global_temperature", gross_economic_output, consumption_per_capita
        data_shape=2,
